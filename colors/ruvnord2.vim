...
"+--- Editor ---+
call s:hi("ColorColumn", "", s:nord1_gui, "NONE", s:nord3_term, "", "")
...
call s:hi("LineNr", s:nord3_gui, "NONE", 247, "NONE", "", "")
call s:hi("MatchParen", s:nord8_gui, s:nord3_gui, s:nord8_term, s:nord3_term, "", "")
call s:hi("NonText", s:nord2_gui, "", s:nord3_term, "", "", "")
call s:hi("Normal", s:nord4_gui, s:nord0_gui, "NONE", "0", "", "")
...
call s:hi("Folded", s:nord_comment, s:nord_comment, s:nord_comment, s:nord1_term, s:bold, "")
...
call s:hi("Comment", s:nord3_gui_bright, "", s:nord_comment, "", s:italicize_comments, "")
